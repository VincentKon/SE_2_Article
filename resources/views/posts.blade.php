...
@section('container')
    ...
    <div class="card mb-3 align-items-center">
      ...
      <div style="max-height: 400px; max-width: 1200px; overflow: scroll;">
        <img src="{{ asset('storage/'.$posts[0]->image) }}"  alt="{{ $posts[0]->category->name }}" alt="{{ $posts[0]->category->name }}" class="img-fluid mt-3 " style="border: 1px solid black">
    </div>

      @else
      <img src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" class="card-img-top" alt="{{ $posts[0]->category->name }}" style="width: 95%; length: 400px; border: 1px solid black">
        @endif
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <div style="max-height: 300px; max-width: 500px; overflow: hidden;">
                <img src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg"  alt="{{ $post->category->name }}" class="img-fluid mt-3" style="max-width: 500px; max-height: 400px">
